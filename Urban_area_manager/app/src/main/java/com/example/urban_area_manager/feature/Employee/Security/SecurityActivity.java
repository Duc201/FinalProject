...
import com.example.urban_area_manager.databinding.ActivitySecurityBinding;
...
public class SecurityActivity extends BaseActivity<ActivitySecurityBinding, SecurityViewModel> {
    ...
    @Override
    protected ActivitySecurityBinding getViewBinding() {
        return ActivitySecurityBinding.inflate(getLayoutInflater());
    }
    ...
    public void onCommonViewLoaded() {
        ...
        SecurityMainViewPagerAdapter securityMainViewPagerAdapter = new SecurityMainViewPagerAdapter(this);
        binding.mainVp2.setAdapter(securityMainViewPagerAdapter);
