...
import com.example.urban_area_manager.databinding.FragmentSelectBuildingBinding;
import com.example.urban_area_manager.feature.Employee.Repair.Bill.SelectedBuildingFragment;
...
public class SelectBuildingFragment extends BaseFragment<FragmentSelectBuildingBinding,BillViewModel> {
    ...
    public void addViewListener() {
        viewBinding.apNextBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                openFragment(listBillFragment,R.id.frame_bill_activity,bundle);
            }
        });
    ...
    @Override
    protected FragmentSelectBuildingBinding getBinding(LayoutInflater inflater) {
        return FragmentSelectBuildingBinding.inflate(getLayoutInflater());
    }
