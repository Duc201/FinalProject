package com.example.urban_area_manager.core.base;
...
import com.example.urban_area_manager.databinding.DialogLoadingViewBinding;
...
//        viewModel.setContext(this);
    ...
    public void replaceFragment(BaseFragment<?,?> fragment,int layout, boolean animate,boolean addbackstack) {
        replaceFragment(
                fragment,
                fragment.getTagFragment(),
                layout,
    ...
    protected void replaceFragment(BaseFragment<?,?> fragment, String tag,int layout, boolean animate,boolean addbackstack) {
        FragmentManager fragmentManager = getSupportFragmentManager();
        FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
        if(addbackstack){
            fragmentTransaction.addToBackStack(tag != null ? tag : fragment.getTagFragment());
    ...
    public void replaceFragmentBundle(BaseFragment<?,?> fragment,int layout, boolean animate,boolean addbackstack,Bundle bundle) {
        replaceFragmentBundle(
                fragment,
                fragment.getTagFragment(),
                layout,
                animate,
    ...
    protected void replaceFragmentBundle(BaseFragment<?,?> fragment, String tag,int layout, boolean animate,boolean addbackstack, Bundle bundle) {
