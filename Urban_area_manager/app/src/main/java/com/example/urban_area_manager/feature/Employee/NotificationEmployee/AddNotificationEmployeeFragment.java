...
import com.example.urban_area_manager.databinding.FragmentAddNotificationEmployeeBinding;
...
public class AddNotificationEmployeeFragment extends BaseFragment<FragmentAddNotificationEmployeeBinding, NotificationViewModel> {
    ...
    public void onCommonViewLoaded() {
            if(DataLocalManager.getPosition() == 0){
                viewBinding.spinNotification.setText("Sửa chữa bảo dưỡng");
            }
            if(DataLocalManager.getPosition() == 1){
                viewBinding.spinNotification.setText("An ninh - trật tự");
            }
    ...
    @Override
    protected FragmentAddNotificationEmployeeBinding getBinding(LayoutInflater inflater) {
        return FragmentAddNotificationEmployeeBinding.inflate(getLayoutInflater());
    }
    ...
    protected String getTagFragment() {
        return AddNotificationEmployeeFragment.class.getSimpleName();
    }
