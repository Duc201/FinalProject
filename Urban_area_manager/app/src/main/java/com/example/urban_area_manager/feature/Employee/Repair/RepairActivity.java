...
import com.example.urban_area_manager.databinding.ActivityRepairBinding;
...
public class RepairActivity extends BaseActivity<ActivityRepairBinding, RepairViewModel> {
    ...
    @Override
    protected ActivityRepairBinding getViewBinding() {
    ...
    public void onCommonViewLoaded() {
        ...
        RepairMainViewPagerAdapter repairMainViewPagerAdapter = new RepairMainViewPagerAdapter(this);
        binding.mainVp2.setAdapter(repairMainViewPagerAdapter);
