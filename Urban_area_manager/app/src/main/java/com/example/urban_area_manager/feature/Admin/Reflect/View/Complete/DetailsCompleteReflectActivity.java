...
import com.example.urban_area_manager.databinding.ActivityDetailsCompleteReflectBinding;
...
public class DetailsCompleteReflectActivity extends BaseActivity<ActivityDetailsCompleteReflectBinding, ReflectViewModel> implements OnMapReadyCallback {
    ...
    @Override
    protected ActivityDetailsCompleteReflectBinding getViewBinding() {
        return ActivityDetailsCompleteReflectBinding.inflate(getLayoutInflater());
    }
    ...
    public void onCommonViewLoaded() {
        ...
        if (bundle != null) {
            reflect = (Reflect) bundle.getSerializable(Constant.GO_TO_DetailsCompleteReflect);
        }
