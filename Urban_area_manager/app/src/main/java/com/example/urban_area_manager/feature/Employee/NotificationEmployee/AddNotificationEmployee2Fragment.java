...
import com.example.urban_area_manager.databinding.FragmentAddNotificationEmployee2Binding;
...
public class AddNotificationEmployee2Fragment extends BaseFragment<FragmentAddNotificationEmployee2Binding, NotificationViewModel> {
                ...
                if(apartment.getName().equals("Tất cả")){
                    ...
                    if(detailsResident.getNameUser().equals("Tất cả")){
                        ...
                        for(DetailsResident detailsResident1 : detailsResidentList){
                            ...
                            if(viewBinding.spinNotification.getSelectedItemPosition() ==0 ){
    ...
    @Override
    protected FragmentAddNotificationEmployee2Binding getBinding(LayoutInflater inflater) {
        return FragmentAddNotificationEmployee2Binding.inflate(getLayoutInflater());
    }
    ...
    protected String getTagFragment() {
        return AddNotificationEmployee2Fragment.class.getSimpleName();
    }
    private void setSpinnerDepartment(){
        spinnerNotificationAdapter = ArrayAdapter.createFromResource(getActivity(), R.array.spinner_notification1, R.layout.spinner_item);
