...
import com.example.urban_area_manager.databinding.ActivityAdministrattiveBinding;
import com.example.urban_area_manager.feature.Employee.EmployeeInfor.EmployeeInformationActivity;

public class AdministrattiveActivity extends BaseActivity<ActivityAdministrattiveBinding, AdministrativeViewModel> {


    @Override
    protected ActivityAdministrattiveBinding getViewBinding() {
        return ActivityAdministrattiveBinding.inflate(getLayoutInflater());
    }
    ...
    public void onCommonViewLoaded() {
        ...
        AdministrativeMainViewPagerAdapter administrativeMainViewPagerAdapter = new AdministrativeMainViewPagerAdapter(this);
        binding.mainVp2.setAdapter(administrativeMainViewPagerAdapter);
